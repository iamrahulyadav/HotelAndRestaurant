...
import com.shoaibnwar.hotelandrestaurant.Fragments.FragmentsAll;
import com.shoaibnwar.hotelandrestaurant.Fragments.FragmentsAssigned;
import com.shoaibnwar.hotelandrestaurant.Fragments.FragmentsUnAssigned;
import com.shoaibnwar.hotelandrestaurant.R;

import java.util.ArrayList;
import java.util.HashMap;

public class ActivityFoodOrders extends AppCompatActivity {
    ...
    private void init(){
        ...
        tab_rl_diary.setBackground(ContextCompat.getDrawable(ActivityFoodOrders.this, R.color.white));
        tab_tv_dairy.setTextColor(ContextCompat.getColor(ActivityFoodOrders.this, R.color.colorPink));
    ...
    private void onDairyTabClickListener(){
        ...
        tab_rl_diary.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                tab_rl_diary.setBackground(ContextCompat.getDrawable(ActivityFoodOrders.this, R.drawable.tab_button_style_after_click));
                tab_tv_dairy.setTextColor(ContextCompat.getColor(ActivityFoodOrders.this, R.color.colorPink));
                tab_iv_dairy.setImageResource(R.drawable.breakfast_icon);

                tab_rl_pets.setBackground(ContextCompat.getDrawable(ActivityFoodOrders.this, R.drawable.tabs_button_style));
                tab_tv_pets.setTextColor(ContextCompat.getColor(ActivityFoodOrders.this, R.color.colorWhite));
                tab_iv_pets.setImageResource(R.drawable.lunch_icon);

                tab_rl_equine.setBackground(ContextCompat.getDrawable(ActivityFoodOrders.this, R.drawable.tabs_button_style));
                tab_tv_equine.setTextColor(ContextCompat.getColor(ActivityFoodOrders.this, R.color.colorWhite));
    ...
    private void onPetTabClickListener(){
        ...
        tab_rl_pets.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                tab_rl_diary.setBackground(ContextCompat.getDrawable(ActivityFoodOrders.this, R.drawable.tabs_button_style));
                tab_tv_dairy.setTextColor(ContextCompat.getColor(ActivityFoodOrders.this, R.color.colorWhite));
                tab_iv_dairy.setImageResource(R.drawable.breakfast_icon);

                tab_rl_pets.setBackground(ContextCompat.getDrawable(ActivityFoodOrders.this, R.drawable.tab_button_style_after_click));
                tab_tv_pets.setTextColor(ContextCompat.getColor(ActivityFoodOrders.this, R.color.colorPink));
                tab_iv_pets.setImageResource(R.drawable.lunch_icon);
    ...
    private void onEquineTabClickListener(){
        ...
        tab_rl_equine.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                tab_rl_equine.setBackground(ContextCompat.getDrawable(ActivityFoodOrders.this, R.drawable.tab_button_style_after_click));
                tab_tv_equine.setTextColor(ContextCompat.getColor(ActivityFoodOrders.this, R.color.colorPink));
                tab_iv_equine.setImageResource(R.drawable.dinner_icon);
...
*/
   ...
   /*     progress_bar.setVisibility(View.GONE);
    ...
    private void onBackArrowClickistner(){
