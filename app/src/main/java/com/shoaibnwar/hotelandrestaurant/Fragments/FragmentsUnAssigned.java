...
public class FragmentsUnAssigned extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View v = inflater.inflate(R.layout.fragment_unassigned_layout, container, false);
        init(v);
        return v;
    }
        ...
        for (OrderFoodDbHelper helper:list){
            ...
            if (!trackingCode.equals(trackinId)) {
                if (assigneStatus.equals("0")) {
                    ...
                    Log.e("Tag" , "the assign status is " + assigneStatus);
                    Log.e("Tag" , "the assign status is " + date + " " + time);
                }
            }
        }
    }
